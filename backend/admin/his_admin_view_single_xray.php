                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xl-7">
                                                <div class="pl-xl-3 mt-3 mt-xl-0">
                                                    <h2 class="mb-3">Name : <?php echo $row->xray_pat_name;?></h2>
                                                    <hr>
                                                    <h3 class="mb-3">Age : <?php echo $row->xray_pat_age;?> Years</h3>
                                                    <hr>
                                                    <h3 class="mb-3">Patient Number : <?php echo $row->xray_pat_number;?></h3>
                                                    <hr>
