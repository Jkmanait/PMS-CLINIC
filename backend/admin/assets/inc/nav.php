<div class="navbar-custom" style="height: 100px; padding: 15px; background-color: #FFB6C1;">
    <ul class="list-unstyled topnav-menu float-right mb-0">
        <li class="dropdown d-none d-lg-block ml-auto" style="position: relative;">
            ...
            <div class="dropdown-menu" style="margin-left: -90px; color: black; position: relative;">
                ...
                <a href="his_admin_add_medical_record.php" class="dropdown-item" style="font-size: 18px; color: black;">
        ...
        <li class="dropdown notification-list ">
            ...
            <div class="dropdown-menu dropdown-menu-right profile-dropdown ">
                <div class="dropdown-header noti-title">
                    <h6 class="text-overflow m-0" style="font-size: 18px; color: black;">Welcome!</h6>
                </div>
                <a href="his_admin_account.php" class="dropdown-item notify-item" style="font-size: 18px; color: black;">
                    <i class="fe-user"></i>
                    <span>My Account</span>
                </a>
                <div class="dropdown-divider"></div>
                <a href="his_admin_logout_partial.php" class="dropdown-item notify-item" style="font-size: 18px; color: black;">
    ...
    <div class="logo-box" style="display: flex; align-items: center; white-space: nowrap;">
        ...
        <span class="logo-lg">
    <img src="assets/images/logo.jpg" style="height: 100px; width: 100px; margin-top: -3px; border-radius: 45%;" alt="Logo">
</span>
