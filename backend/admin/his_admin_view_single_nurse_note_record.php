    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <?php
                ...
                $ret="SELECT  * FROM his_nurse_note WHERE nur_id = ?";
                $stmt= $mysqli->prepare($ret) ;
                $stmt->bind_param('i',$nur_id);
                $stmt->execute() ;//ok
                $res=$stmt->get_result();
                //$cnt=1;
                while($row=$res->fetch_object())
                {
                    $mysqlDateTime = $row->nur_date_rec;
            ?>
                                    ...
                                    <div class="page-title-box">
                                        <div class="page-title-right">
                                            <ol class="breadcrumb m-0">
                                                ...
                                                <li class="breadcrumb-item"><a href="javascript: void(0);">Nurse's Note Records</a></li>
                                                <li class="breadcrumb-item active">View Records</li>
                                            </ol>
                                        </div>
                                        <!-- <h4 class="page-title">#<?php echo $row->nur_number;?></h4> -->
                                    </div>
                                </div>
                            </div>     
                            <!-- end page title --> 
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xl-7">
                                                <div class="pl-xl-3 mt-3 mt-xl-0">
                                                    <h2 class="mb-3">Patient's Name : <?php echo $row->nur_note_name;?></h2>
                                                    <hr>
                                                    <h3 class="text-danger ">Patient Number : <?php echo $row->nur_note_number;?></h3>
                                                    <hr>
                                                    <h3 class="text-danger ">Patient Ailment : <?php echo $row->nur_note_ailment;?></h3>
                                                    <hr>
                                                    <h3 class="text-danger ">Date Recorded : <?php echo date("d/m/Y - h:m:s", strtotime($mysqlDateTime));?></h3>
                                                    <hr>
                                                    <h2 class="align-centre">Nurse's Note</h2>
                                                    <hr>
                                                    <p class="text-muted mb-4">
                                                        <?php echo $row->nur_note_tests;?>
                                                    </p>
                                                    <hr>
                                                    <h2 class="align-centre">Nurse's Note Result</h2>
                                                    <p class="text-muted mb-4">
                                                        <?php echo $row->nur_note_results;?>
                                                    </p>
                                                    <hr>
                                                   <!--
